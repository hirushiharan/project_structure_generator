...
root_directory = "D:/ai/email-classification-sandbox"
gitignore_file_path = "D:/ai/email-classification-sandbox/.gitignore"
custom_patterns = [".git"]

project = ProjectStructure(root_dir=root_directory, gitignore_file=gitignore_file_path, custom_patterns=custom_patterns)
project.generate()